...
<head>
    ...
    <link rel="stylesheet" href="../../css/style/tableM.css">
...
<body>
    <nav class="navMenu">
        ...
        <a href="registrar3.php">Registrar</a>
    ...
    <div>
        ...
        $query = "SELECT * FROM tipovehiculo LIMIT $inicio,$articulosPagina";
        ...
        <table class="styled-table">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td><?php echo $row['idTvehiculo']; ?></td>
                        <td><?php echo $row['tipoVehiculo']; ?></td>
                        <td>
                            <a href="delete.php?idTvehiculo=<?php echo $row['idTvehiculo'] ?>">
                                Delete
                            </a>
                        <th>
                            <a href="view.php?idTvehiculo=<?php echo $row['idTvehiculo'] ?> #openModal">
                                Ver
                            </a>
                        </th>

                        <th>
                            <a href="edit.php?idTvehiculo=<?php echo $row['idTvehiculo'] ?> ">
                                Editar
                            </a>
                        </th>
                        </td>
                ...
                <?php } ?>
                <nav aria-label="Page navigation example" style="margin: 365px;">
                    <ul class="pagination">
                        <?php
                        for ($i = 0; $i < $paginas; $i++) :
                        ?>
